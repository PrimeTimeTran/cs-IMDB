...
class App extends React.Component {
  ...
  getMovies = async () => {
    ...
    const response = await fetch(
      `https://api.themoviedb.org/3/movie/top_rated?api_key=4c5b4a5e627748117d4b24082672a9b4&page=${pageNumber}`
    );
  ...
  renderToolbar() {
    return (
      ...
      >
        ...
        <Button
          onClick={this.onSortLeastToMostPopular}
          style={{
            fontSize: 20,
            fontWeight: "bold",
            backgroundColor: "#E3C5BB"
    ...
    return (
      <div style={containerStyle}>
        ...
        <Row style={primaryRowStyle}>
          ...
          <Col>
            {this.renderToolbar()}
            <Row style={movieContainerStyle}>{this.renderMovies()}</Row>
            <div
              style={{
                paddingTop: 10,
                display: "flex",
            ...
            >
              <Button
                ...
                variant="primary"
                style={getMoreMoviesButtonStyle}
              >
                Get More
              </Button>
